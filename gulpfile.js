 ...
 *
 * gulp                 	Build/serve/watch dev environment on port 8080 (copies Angular 2 UMD bundles and compiles TypeScript/Sass on start, no compilation of TypeScript/Sass/Pug during watch task, suitable for IDEs)
 ...
 * gulp build:prod      	Build prod environment (compiles TypeScript/Sass/Pug, processes index.html, bundles vendor and Angular 2 JS files into one "app.min.js" file, bundles CSS into one file and copies static files into dist/ folder)
...
gulp.task('build:prod', function(done) {
	runSequence('dev:tslint', 'prod:clean', 'prod:compile:sass', 'dev:compile:pug', 'dev:compile:typescript', 'prod:compile:aot', 'prod:bundle:js', 'prod:bundle:vendor-css', 'prod:preprocess:html', 'prod:copy:static', 'prod:clean:post', done);
});
